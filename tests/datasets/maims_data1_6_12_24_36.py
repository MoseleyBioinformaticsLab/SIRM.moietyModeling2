...
dataset1 = moiety_modeling.Dataset("6h", {'UDP_GlcNAC': [{'labelingIsotopes': '13C0', 'height': 0.064103528, 'heightSE': 0},
...
dataset2 = moiety_modeling.Dataset("12h", {'UDP_GlcNAC': [{'labelingIsotopes': '13C0', 'height': 0.0175442549, 'heightSE': 0},
                                                        {'labelingIsotopes': '13C1', 'height': 0, 'heightSE': 0},
...
dataset3 = moiety_modeling.Dataset("24h", {'UDP_GlcNAC': [{'labelingIsotopes': '13C0', 'height': 0.00697626, 'heightSE': 0},
                                                        {'labelingIsotopes': '13C1', 'height': 0, 'heightSE': 0},
...
dataset4 = moiety_modeling.Dataset("36h", {'UDP_GlcNAC': [{'labelingIsotopes': '13C0', 'height': 0.0009166044, 'heightSE': 0},
                                                        {'labelingIsotopes': '13C1', 'height': 0, 'heightSE': 0},
...
with open('maims_data1_6_12_24_36.json', 'w') as outFile:
